...
def read_attendance_by_employee(
    employee_id: int,
    skip: int = 0,
    limit: int = 100,
...
@router.get(
    "/",
    response_model=List[schemas.AttendanceWithEmployee]
)
def read_all_attendance(
    ...
    Returns:
        List of attendance records with employee information
    """
